...
# first run this
chmod 777 $(pwd) #NOT GOOD FOR PROD ENV
echo $(id -u):$(id -g)
...
# Generate ConfigFile
# docker run -v $(pwd):/zap/wrk/:rw -t owasp/zap2docker-weekly zap-api-scan.py -t http://devsecops-demo-adnann.eastus.cloudapp.azure.com:30164/v3/api-docs -f openapi -c gen_file